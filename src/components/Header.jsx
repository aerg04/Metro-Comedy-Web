...
export default function Header(){
    ...
    return(
        <header className='bg-blue-900 top-0 w-full z-50'>
            <nav className='flex items-center justify-between w-[92%] mx-auto'>
                ...
                <div className={toggled ? ' text-xl md:static absolute bg-blue-900 md:min-h-fit min-h-[25vh] left-0 top-[10%] md:w-auto w-full z-20 flex items-center px-5 ':'text-xl md:static absolute  md:min-h-fit min-h-[60vh] left-0 top-[-100%] md:w-auto w-full flex items-center px-5 '}>
                ...
                <div className='flex z-30 items-center md:hidden cursor-pointer relative' >
                    ...
                    <span className={`block w-full h-0.5 bg-white transform transition duration-300 ease-in-out ${toggled ? 'rotate-45 translate-y-2' : ''}`}></span>
                    <span className={`block w-full h-0.5 bg-white transform transition duration-300 ease-in-out ${toggled ? 'opacity-0' : ''}`}></span>
                    <span className={`block w-full h-0.5 bg-white transform transition duration-300 ease-in-out ${toggled ? '-rotate-45 -translate-y-2' : ''}`}></span>
